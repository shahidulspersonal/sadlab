      ...
      <table class="table">
         ...
         <tbody>
            <?php
               ...
               $select = mysqli_query($conn, "SELECT name, email, image FROM jobseeker") or die('query failed');
         ...
         echo '<td><img src="uploaded_img/'.$row['image'].'" alt="JobSeeker Image" width="50"></td>';
         echo "</tr>";
     }
